...
Everything here shipped. Project identifiers and customer data are stripped; the SQL is otherwise as applied. Each file carries its own header explaining why it exists and what it refuses to assume.
...
`sql/2026-07-16-durable-rate-limit-ledger.sql`
...
`sql/2026-08-16-render-attempt-idempotency.sql` and `sql/2026-08-17-fix-claim-render-attempt-ambiguity.sql`
...
`sql/2026-07-16-stripe-event-claims.sql`
...
`sql/2026-07-15-invoice-effect-outbox.sql` and `sql/2026-07-17-invoice-effect-lease.sql`
...
`sql/2026-08-01-render-receipts.sql`
...
`sql/2026-08-30-onboarding-state-machine.sql` and `sql/2026-08-21-proposal-client-as-built-atomic.sql`
...
`sql/2026-07-16-proposal-create-idempotency.sql`
...
`sql/2026-06-19-rls-lockdown.sql` and `sql/2026-07-16-public-schema-lockdown.sql`
...
`sql/2026-09-02-outbound-gate.sql`
...
`sql/2026-06-17-invoice-seq.sql`
...
`sql/2026-08-26-support-tickets.sql`
...
- `BEGIN; SET LOCAL lock_timeout = '5s';` so a migration never queues behind a long transaction in production.
...
- A rollback block or a one-line reversal note at the bottom.
